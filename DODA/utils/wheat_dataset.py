...
class WheatUnconditionaltBase(Dataset):
    ...
    def __getitem__(self, i):
        ...
        if random.random() < self.ag_rate:
            ...
            square_size = h
            center = (h // 2, w // 2)
            square_points = np.array([(0, 0), (0, square_size), (square_size, 0), (square_size, square_size)],
                                     dtype=np.float32)
...
class wheatUnconditionalTrain(WheatUnconditionaltBase):
    def __init__(self, txt_file="datasets/wheat2/train_ldm.txt", data_root="datasets/wheat2/target", **kwargs):
        super().__init__(txt_file, data_root,
                         **kwargs)


class wheatUnconditionalValidation(WheatUnconditionaltBase):
    def __init__(self, txt_file="datasets/wheat2/val_ldm.txt", data_root="datasets/wheat2/target", flip_p=0., ag_rate=0.,
                 **kwargs):
        super().__init__(txt_file, data_root,
...
class wheatConditionalTrain(WheatConditionaltBase):
    def __init__(self, **kwargs):
        super().__init__(txt_file="datasets/wheatnw/train_cldm.txt", data_root="datasets/wheatnw", **kwargs)


class wheatConditionalValidation(WheatConditionaltBase):
    def __init__(self, flip_p=0., ag_rate=0., **kwargs):
        super().__init__(txt_file="datasets/wheatnw/val_cldm.txt", data_root="datasets/wheatnw", **kwargs)