...
output_path = 'datasets/aaalayout/'
...
ann_Path = 'datasets/scab2021/competition_train.csv'
base_w = 55
base_h = 50
w_scale = (0.15, 2)
h_scale = (0.15, 2)
...
def random_select_boxes(box_wh_lst, max_boxes_number=200, image_size=416, orginal_size=416):
...
def draw_control_img(bboxes, min_box_num=2, max_box_num=15, image_size=416):
    isolated_boxes = []
    overlaped_boxes = []
...
if use_wh_from_target_domain:
    box_wh_lst = convert_ann2wh(ann_Path)
else:
